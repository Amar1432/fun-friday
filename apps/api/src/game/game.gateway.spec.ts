...
describe('GameGateway', () => {
  ...
  const redisRoomRepositoryMock = {
    ...
    createRoomState: jest.fn().mockResolvedValue(undefined),
    ...
    setPlayer: jest.fn().mockResolvedValue(undefined),
    removePlayer: jest.fn().mockResolvedValue(undefined),
    deleteRoomState: jest.fn().mockResolvedValue(undefined),
    updateLeaderboardScore: jest.fn().mockResolvedValue(undefined),
    getLeaderboard: jest.fn().mockResolvedValue([]),
    loadQuestions: jest.fn().mockResolvedValue(undefined),
    getQuestion: jest.fn().mockResolvedValue(null),
    hasQuestions: jest.fn().mockResolvedValue(false),
    getAnswers: jest.fn().mockResolvedValue([]),
    setAnswer: jest.fn().mockResolvedValue(undefined),
    updatePlayerScores: jest.fn().mockResolvedValue(undefined),
    expireAllRoomKeys: jest.fn().mockResolvedValue(undefined),
    removePlayerDisconnectedStatus: jest.fn().mockResolvedValue(undefined),
  };
