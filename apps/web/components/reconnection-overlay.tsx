  ...
  return (
    ...
    >
      <div className="bg-slate-900/80 border border-slate-800/80 max-w-md w-full rounded-3xl p-8 space-y-6 text-center shadow-2xl relative overflow-hidden">
        ...
        <div className="mx-auto h-16 w-16 rounded-2xl bg-indigo-500/10 border border-indigo-500/20 flex items-center justify-center text-indigo-400 text-3xl font-bold shadow-lg shadow-indigo-500/5">
          🔄
        </div>
        ...
        <div className="space-y-2">
          ...
          <p className="text-sm text-slate-400 leading-relaxed" data-testid="reconnection-message">
            {isRestoring
